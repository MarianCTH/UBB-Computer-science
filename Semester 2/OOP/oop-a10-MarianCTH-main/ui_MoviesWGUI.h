...
public:
    ...
    void setupUi(QMainWindow *MoviesWGUIClass)
    {
        ...
        undoButton->setGeometry(QRect(20, 350, 51, 24));
        redoButton = new QPushButton(centralWidget);
        redoButton->setObjectName("redoButton");
        redoButton->setGeometry(QRect(90, 350, 51, 24));
        watchListTable = new QTableView(centralWidget);
        watchListTable->setObjectName("watchListTable");
        watchListTable->setGeometry(QRect(210, 20, 481, 241));
        showTableButton = new QPushButton(centralWidget);
        showTableButton->setObjectName("showTableButton");
        showTableButton->setGeometry(QRect(30, 390, 80, 24));
    ...
    void retranslateUi(QMainWindow *MoviesWGUIClass)
    {
        ...
        undoButton->setText(QCoreApplication::translate("MoviesWGUIClass", "Undo", nullptr));
        redoButton->setText(QCoreApplication::translate("MoviesWGUIClass", "Redo", nullptr));
        showTableButton->setText(QCoreApplication::translate("MoviesWGUIClass", "Show table", nullptr));
    } // retranslateUi
